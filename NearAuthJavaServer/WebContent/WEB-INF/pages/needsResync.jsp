    ...
    <div id="failureBody">
        <div id="centerPanelCo">
            ...
            <div id="centerPanelTableWide">
                <div id="failureMessage1">NearAuth.ai needs to be resychronized with this browser.
                Please open NearAuth.ai, select Add Browser, and follow the directions.</div> 
            </div>
